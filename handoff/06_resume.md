...
1. Keep r10 running and collect a scheduled multi-hour or 24-hour trend of
...
4. Keep the r10 APK and pre-install backups until rollback is unnecessary.
...
5. Keep the production router on its current r10 silent state until a package
